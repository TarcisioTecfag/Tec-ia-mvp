...
const updateUserSchema = z.object({
    ...
    canViewChat: z.boolean().nullable().optional(),
    canViewMindMap: z.boolean().nullable().optional(),
    canViewCatalog: z.boolean().nullable().optional(),
    canViewUsers: z.boolean().nullable().optional(),
    canViewMonitoring: z.boolean().nullable().optional(),
    canViewDocuments: z.boolean().nullable().optional(),
    canViewSettings: z.boolean().nullable().optional(),
    canViewNotifications: z.boolean().nullable().optional(),
});
