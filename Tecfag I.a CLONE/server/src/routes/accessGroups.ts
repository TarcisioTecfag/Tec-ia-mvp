...
const createGroupSchema = z.object({
    ...
    canViewNotifications: z.boolean().optional().default(true),
    // Permissões de ação - Mapa Mental
    canCreateMindMap: z.boolean().optional().default(true),
    canEditMindMap: z.boolean().optional().default(true),
    canDeleteMindMap: z.boolean().optional().default(false),
    // Permissões de ação - Catálogo
    canCreateCatalog: z.boolean().optional().default(false),
    canEditCatalog: z.boolean().optional().default(false),
    canDeleteCatalog: z.boolean().optional().default(false),
    // Permissões de ação - Usuários
    canCreateUsers: z.boolean().optional().default(false),
    canEditUsers: z.boolean().optional().default(false),
    canDeleteUsers: z.boolean().optional().default(false),
    // Permissões de ação - Documentos
    canUploadDocuments: z.boolean().optional().default(false),
    canEditDocuments: z.boolean().optional().default(false),
    canDeleteDocuments: z.boolean().optional().default(false),
    // Permissões de ação - Chat
    canArchiveChat: z.boolean().optional().default(true),
    canDeleteChatHistory: z.boolean().optional().default(true),
    // Permissões de ação - Notificações
    canDeleteNotifications: z.boolean().optional().default(true),
    // Permissões de administração
    canManageAccessGroups: z.boolean().optional().default(false),
    canManageBackups: z.boolean().optional().default(false),
    canViewTokenCosts: z.boolean().optional().default(false),
});
...
const updateGroupSchema = z.object({
    ...
    // Permissões de ação - Mapa Mental
    canCreateMindMap: z.boolean().optional(),
    canEditMindMap: z.boolean().optional(),
    canDeleteMindMap: z.boolean().optional(),
    // Permissões de ação - Catálogo
    canCreateCatalog: z.boolean().optional(),
    canEditCatalog: z.boolean().optional(),
    canDeleteCatalog: z.boolean().optional(),
    // Permissões de ação - Usuários
    ...
    // Permissões de ação - Chat
    canArchiveChat: z.boolean().optional(),
    canDeleteChatHistory: z.boolean().optional(),
    // Permissões de ação - Notificações
    canDeleteNotifications: z.boolean().optional(),
    // Permissões de administração
    canManageAccessGroups: z.boolean().optional(),
    canManageBackups: z.boolean().optional(),
    canViewTokenCosts: z.boolean().optional(),
});
