...
export const NotificationBell = () => {
    ...
    const handleClick = () => {
        // Dispatch events to switch to settings tab and then notifications sub-tab
        // Using a slightly longer delay to ensure the tab switch has processed
        window.dispatchEvent(new CustomEvent('switch-tab', { detail: 'settings' }));
        // Increased timeout to ensure the tab switch has processed
        setTimeout(() => {
