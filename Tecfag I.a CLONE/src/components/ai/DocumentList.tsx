...
import { FileText, Trash2, RefreshCw, Download, CheckSquare, Square, CheckCheck, Wand2 } from 'lucide-react';
...
interface DocumentListProps {
    ...
    onFixEncoding?: (documentId: string) => void;
                    ...
                    <div className="flex items-start justify-between">
                        ...
                        {!selectionMode && (
                            <div className="flex items-center gap-2 ml-4">
                                ...
                                {doc.indexed && onFixEncoding && (
                                    <button
                                        onClick={() => onFixEncoding(doc.id)}
                                        className="p-2 text-white/40 hover:text-yellow-400 transition-colors"
                                        title="Corrigir Codificação de Texto (Fix Mojibake)"
                                    >
