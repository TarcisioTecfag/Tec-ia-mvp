...
const DocumentsTab = () => {
    ...
    const [documentsToMove, setDocumentsToMove] = useState<string[]>([]);
    ...
    const handleFixEncoding = async (id: string) => {
        try {
            ...
            if (response.ok) {
                ...
                alert('Erro ao corrigir codificação do documento');
            }
        } catch (error) {
    ...
    const handleMoveDocument = async (documentIds: string[], folderId: string | null) => {
        try {
            ...
            setDocumentsToMove([]);
            // Disable selection mode if it was active
            if (selectionMode) {
    ...
    // Bulk move is now handled by openMoveDialog(selectedIds)
    ...
    return (
        <div className="h-full flex bg-background">
            ...
            <MoveDocumentDialog
                ...
                onMove={(targetFolderId) => handleMoveDocument(documentsToMove, targetFolderId)}
                folders={folders}
