                    ...
                    <DialogContent className="sm:max-w-md">
                        ...
                        <div className="py-4">
                            <div className="space-y-4">
                                {/* Basic Info */}
                                <div className="space-y-4">
                                    <h3 className="text-sm font-semibold border-b pb-2 mb-4 flex items-center gap-2">
                                        <UserIcon className="w-4 h-4" /> Dados Cadastrais
                                    </h3>
                                    ...
                                    <div className="flex items-center space-x-2 pt-2 bg-muted/30 p-2 rounded-md">
                                        <input
                                            type="checkbox"
