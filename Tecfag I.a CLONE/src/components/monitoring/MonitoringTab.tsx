...
import { monitoringApi, UserStatus, UserArchivedChatsGroup, QuestionStatistics, CostsData } from "@/lib/api";
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@/components/ui/card";
import { Skeleton } from "@/components/ui/skeleton";
import { Activity, BarChart3, MessageSquare, Users, DollarSign } from "lucide-react";
            ...
            <div className="container mx-auto px-4 py-6 space-y-6">
                ...
                <div className="flex gap-2 border-b border-border pb-2">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-t-lg transition-colors flex items-center gap-2 ${activeSection === "costs"
                            ? "bg-primary/10 text-primary border-b-2 border-primary"
                            : "text-muted-foreground hover:text-foreground"
                            }`}
                    >
