...
import { Clock, MessageSquare, Trash2, Edit2, Pin, PinOff, FolderInput, CheckSquare, Square } from "lucide-react";
...
const ArchivedChatCard = ({
    ...
    return (
        <div
            className={`group relative bg-[#1a1a1a] rounded-lg p-2.5 border transition-all duration-200 cursor-pointer ${isSelected
        ...
        >
            ...
            {/* Action Buttons (Hidden handling selection mode) */}
            {!selectionMode && (
